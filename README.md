...
<img width="1254" height="1254" alt="milad-vaghef-portfolio-v1-desktop" src="https://github.com/user-attachments/assets/beb8d394-f9e4-4baa-a653-46f2016bb260" />
...
This portfolio has been built with a fully responsive layout so it can be viewed seamlessly across different devices and screen sizes. Special attention has been given to touch interactions, swipe gestures, and adaptive UI components to ensure a smooth experience on tablets, phones, and desktops alike.
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/MiladVaghef/Milad-Vaghef-Portfolio-v1.git
   ```

2. Navigate into the project directory:

   ```bash
   cd Milad-Vaghef-Portfolio-v1
   ```
...
This will start the project on `http://localhost:5173` (or another port if 5173 is already in use).
